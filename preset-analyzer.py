...
parser = argparse.ArgumentParser(description='Path to the Steam Workshop directory is needed for proper execution.')
parser.add_argument('workshop', type=str, help='Path to the Steam Workshop directory')

args = parser.parse_args()
workshop = args.workshop
# Workshop-Path:
wspath = workshop + '\\content\\107410'
